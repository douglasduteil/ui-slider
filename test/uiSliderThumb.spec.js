...
describe('uiSliderThumb', function () {
  ...
  describe('restrictions', function () {
    ...
    it('should work as an element', function () {
      const element = this.compileSliderContent('<ui-slider-thumb ng-model="_"></ui-slider-thumb>')(this.$rootScope);
      expect(element.scope().uiSliderThumbCtrl).to.be.ok;
    });

    it('should not work as an attribute', function () {
      const element = this.compileSliderContent('<div ui-slider-thumb></div>')(this.$rootScope);
      expect(element.scope().uiSliderThumbCtrl).not.to.be.ok;
    });

    it('should not work as an class', function () {
<<<<<<< HEAD
      const element = this.compileSliderContent('<div class="ui-slider-thumb"></div>')(this.$rootScope);
=======
...
>>>>>>> 9422a8e... draft: a lot of test on the thmub
      expect(element.scope().uiSliderThumbCtrl).not.to.be.ok;
    });
